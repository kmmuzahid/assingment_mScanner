...
/// Palette matching the scanner/saved-file-list mockup screenshots
/// (near-black page background, navy-slate app bar, mint-green accents).
class MockupColors {
  static const Color pageBackground = Color(0xFF0B1014);
  static const Color appBarBackground = Color(0xFF16262D);
  static const Color cardBackground = Color(0xFF112027);
  static const Color cardBorder = Color(0xFF1E3338);
  static const Color mint = Color(0xFF60ccbb);
  static const Color tealTabActive = Color(0xFF1B4D44);
  static const Color textWhite = Color(0xFFFFFFFF);
  static const Color textSubtle = Color(0xFF8FA3A8);
  static const Color errorRed = Color(0xFFD9534F);
  static const Color warningAmber = Color(0xFFE0A93C);
}
...
class ThemeColor extends ThemeExtension<ThemeColor> {
  ...
  ThemeColor copyWith({
    ...
    return ThemeColor(
      ...
      bACKGROUND_clickableBorder:
          bACKGROUND_clickableBorder ?? this.bACKGROUND_clickableBorder,
      bACKGROUND_darkCard: bACKGROUND_darkCard ?? this.bACKGROUND_darkCard,
      bACKGROUND_darkCardBoarder:
          bACKGROUND_darkCardBoarder ?? this.bACKGROUND_darkCardBoarder,
      ...
      socialLinksShareBTN_skyBlue:
          socialLinksShareBTN_skyBlue ?? this.socialLinksShareBTN_skyBlue,
      successVerifiedPositivestats_freshGrass:
          successVerifiedPositivestats_freshGrass ??
          this.successVerifiedPositivestats_freshGrass,
  ...
  ThemeColor lerp(ThemeColor? other, double t) {
    ...
    return ThemeColor(
      ...
      bACKGROUND_darkCard: Color.lerp(
        bACKGROUND_darkCard,
        other.bACKGROUND_darkCard,
        t,
      )!,
      ...
      bACKGROUND_darkPage: Color.lerp(
        bACKGROUND_darkPage,
        other.bACKGROUND_darkPage,
        t,
      )!,
      ...
      pRIMARY_brandClr: Color.lerp(
        pRIMARY_brandClr,
        other.pRIMARY_brandClr,
        t,
      )!,
      pRIMARY_priLight: Color.lerp(
        pRIMARY_priLight,
        other.pRIMARY_priLight,
        t,
      )!,
      pRIMARY_priMedium: Color.lerp(
        pRIMARY_priMedium,
        other.pRIMARY_priMedium,
        t,
      )!,
